...
'<img src="~/adminassets/img/icons/siderbar-icon2.svg" class="feather-five" alt="">'+
...
'<img src="~/adminassets/img/logo.png" alt="Logo" class="img-flex">'+
'</a>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 col-sm-6 col-12">'+
'<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="~/adminassets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>'+
'</div>'+
'</div>'+
'</div>'+
'</div>'+
...
'<img class="img-fliud" src="~/adminassets/img/demo-one.png" alt="demo">'+
'</div>'+
'<div class="row">'+
