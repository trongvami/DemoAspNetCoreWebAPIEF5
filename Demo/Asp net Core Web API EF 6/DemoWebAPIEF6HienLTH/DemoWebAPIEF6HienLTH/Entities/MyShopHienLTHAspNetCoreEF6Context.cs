...
{
    public partial class MyShopHienLTHAspNetCoreEF6Context : DbContext
    {
        public MyShopHienLTHAspNetCoreEF6Context()
        {
        }

        public MyShopHienLTHAspNetCoreEF6Context(DbContextOptions<MyShopHienLTHAspNetCoreEF6Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=ADMIN\\SQLEXPRESS;Initial Catalog=MyShopHienLTHAspNetCoreEF6;Persist Security Info=True;User ID=sa;Password=sa");
            }
        }
